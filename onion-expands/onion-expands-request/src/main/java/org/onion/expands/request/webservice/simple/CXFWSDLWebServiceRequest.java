...
import org.onion.expands.request.webservice.WebServiceRequestInvoker;
...
public class CXFWSDLWebServiceRequest implements WebServiceRequest {
    ...
    public CXFWSDLWebServiceRequest(String url) throws Exception {
        CODE_DIR = System.getProperty("java.io.tmpdir") + "/org/onion/request/ws/" + MD5.defaultEncode(url) + "/";
