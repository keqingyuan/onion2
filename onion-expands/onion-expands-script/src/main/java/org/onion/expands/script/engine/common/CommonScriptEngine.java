package org.onion.expands.script.engine.common;

import org.onion.commons.MD5;
import org.onion.expands.script.engine.*;
...
public abstract class CommonScriptEngine extends ListenerSupportEngine {
    ...
    @Override
    public org.onion.expands.script.engine.ScriptContext getContext(String id) {
    ...
    protected class CommonScriptContext extends org.onion.expands.script.engine.ScriptContext {
