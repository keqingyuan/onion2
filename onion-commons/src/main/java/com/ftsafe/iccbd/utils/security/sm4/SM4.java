package com.ftsafe.iccbd.utils.security.sm4;
...
public class SM4 {
    ...
    public int sm4(byte[] in, int inLen, byte[] key, byte[] out, int CryptFlag) {
        int point = 0;
    ...
    public static void main(String[] args) {
        ...
        byte[] msg = {0x01, 0x23, 0x45, 0x67, (byte) 0x89, (byte) 0xab, (byte) 0xcd, (byte) 0xef, (byte) 0xfe, (byte) 0xdc, (byte) 0xba, (byte) 0x98, 0x76, 0x54, 0x32, 0x10};
        ...
        System.out.println("RAW:" + ByteUtil.toHexString(msg));
        sm4.sm4(msg, 16, key, out, SM4.DECRYPT);
        System.out.println("ENC:" + ByteUtil.toHexString(out));
