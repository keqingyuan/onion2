...
public class PppMac extends AbstractMac {
	...
	public static void main(String[] args) {
		byte[] key = ByteUtil.toBytes("F72645892C737597");
		byte[] data = ByteUtil.toBytes("02003020048020C10013190000000000000001000008002181376013822000606913476D12045201000059500032313032333430373939393434303134383132303030300035504147413132333420202020202020202020202020202020202020203030303030302300112200000200100003303031");
		try {
