...
import org.onion.commons.DateTimeUtils;
...
import org.onion.web.bean.common.InsertParam;
...
import org.onion.web.mybatis.utils.SqlAppender;
...
public class DefaultSqlParamBuilder {
    ...
    public String buildSelectFields(String resultMapId, String tableName, org.onion.ezorm.param.SqlParam param) {
        Map<String, Object> fieldConfig = createConfig(resultMapId);
    ...
    public String buildOrder(String resultMapId, String tableName, QueryParam param) throws Exception {
        ...
        Set<org.onion.ezorm.param.Sort> sorts = new LinkedHashSet<>();
    ...
    public Map<String, String> getPropertyMapper(Map<String, Object> fieldConfig, org.onion.ezorm.param.SqlParam param) {
