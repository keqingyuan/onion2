package org.onion.concurrent.lock.support;

import org.aspectj.lang.ProceedingJoinPoint;
import org.aspectj.lang.annotation.Around;
import org.aspectj.lang.annotation.Aspect;
import org.aspectj.lang.reflect.MethodSignature;
import org.onion.concurrent.lock.LockFactory;
import org.onion.concurrent.lock.annotation.LockName;
import org.onion.concurrent.lock.exception.LockException;
...
public class AnnotationLockAopAdvice {
    ...
    public Object unWriteLock(ProceedingJoinPoint pjp,
                              org.onion.concurrent.lock.annotation.UnWriteLock unLock) throws Throwable {
    ...
    public Object unReadLock(ProceedingJoinPoint pjp,
                             org.onion.concurrent.lock.annotation.UnReadLock unLock) throws Throwable {
        String name = getLockName(pjp);
        ReadWriteLock lock = readWriteLockMap.get(name);
        try {
            return pjp.proceed();
    ...
    public Object unlock(ProceedingJoinPoint pjp,
                         org.onion.concurrent.lock.annotation.UnLock unLock) throws Throwable {
        String name = getLockName(pjp);
    ...
    public Object lock(ProceedingJoinPoint pjp,
                       org.onion.concurrent.lock.annotation.Lock lock) throws Throwable {
        String name = getLockName(pjp);
    ...
    public Object readLock(ProceedingJoinPoint pjp,
                           org.onion.concurrent.lock.annotation.ReadLock lock) throws Throwable {
        String name = getLockName(pjp);
    ...
    public Object writeLock(ProceedingJoinPoint pjp,
                            org.onion.concurrent.lock.annotation.WriteLock lock) throws Throwable {
        String name = getLockName(pjp);
        ReadWriteLock readWriteLock = readWriteLockMap.get(name);
        if (readWriteLock == null) {
            synchronized (readWriteLockMap) {
