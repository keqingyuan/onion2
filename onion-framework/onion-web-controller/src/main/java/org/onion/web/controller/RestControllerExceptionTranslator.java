...
import org.onion.web.core.exception.*;
...
public class RestControllerExceptionTranslator {
    ...
    @ExceptionHandler(org.onion.ezorm.exception.ValidationException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    ResponseMessage handleException(org.onion.ezorm.exception.ValidationException exception) {
