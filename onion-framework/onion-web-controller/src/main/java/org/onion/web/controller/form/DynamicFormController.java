...
package org.onion.web.controller.form;
...
import org.onion.web.service.resource.FileService;
 ...
 * 将使用{@link org.onion.web.controller.DynamicFormAuthorizeValidator#validate(String, User, Map, String...)}进行权限验证
 *
 * @author zhouhao
 */
@RestController
...
public class DynamicFormController {
     ...
     * @throws SQLException                                  执行查询sql错误
     * @throws NotFoundException                             表单不存在或在未发布
     * @throws org.onion.ezorm.exception.ValidationException 数据格式验证失败时抛出此异常
     */
     ...
     *
     * @param name   表单名称
     * @param fileId 文件id,通过{@link org.onion.web.controller.file.FileController#upload(MultipartFile[])} 上传后获得
     *               使用,分割可实现同时导入多个文件
