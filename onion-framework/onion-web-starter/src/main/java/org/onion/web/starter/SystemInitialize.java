...
import static org.onion.web.starter.SystemVersion.Property.*;
...
public class SystemInitialize implements InitializingBean {
    ...
    private String installGroovyScriptPackage = "classpath*:org/onion/start/scripts/install/install.groovy";
    private String installSqlScriptPackage    = "classpath*:org/onion/start/scripts/install/sql/{db}/install.sql";

    private String upgradeGroovyScriptPackage = "classpath*:org/onion/start/scripts/upgrade/*.groovy";
    private String upgradeSqlScriptPackage    = "classpath*:org/onion/start/scripts/upgrade/sql/{db}/*.sql";

    private String initializeScriptPackage = "classpath*:org/onion/start/scripts/initialize/initialize.groovy";
    private String initializeSqlPackage    = "classpath*:org/onion/start/scripts/initialize/sql/{db}/initialize.sql";
