...
package org.onion.web.oauth2.service;
...
import org.onion.web.oauth2.dao.OAuth2AccessMapper;
import org.onion.web.oauth2.exception.AccessTimeoutException;
import org.onion.web.oauth2.po.OAuth2Access;
import org.onion.web.service.config.ConfigService;
import org.onion.web.service.user.UserService;
...
public class OAuth2ServiceImpl implements OAuth2Service {
    ...
    static final String cacheName = "onion.oauth2";
    ...
    public int getDefaultExpireIn() {
        return configService.getInt("oauth2", "expire_in", 31104000);
    }
